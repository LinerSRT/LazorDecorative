...
public class BlockLeaves extends BaseMultiMetaBlock implements IShearable {
    ...
    public BlockLeaves(int blockID) {
        ...
        registerType("acacia", "Листья акации",  "acacia");
        registerTexture("acacia",  "leaves_acacia_opaque", 0, 1);
        registerType("big_oak", "Листья тёмного дуба",  "big_oak");
    ...
    public Icon getIcon(int side, int metadata) {
        ...
        TextureData textureData = textureDataMap.get(unlocalizedType).get(graphicsDetails);
    ...
    public ArrayList<ItemStack> onSheared(ItemStack item, World world, int x, int y, int z, int fortune) {
        ...
        ret.add(new ItemStack(this, 1, world.getBlockMetadata(x, y, z) & getTypesCount()));
        return ret;
    }
