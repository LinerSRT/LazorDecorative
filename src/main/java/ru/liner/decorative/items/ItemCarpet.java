...
public class ItemCarpet extends ItemBlock {
    public ItemCarpet(int carpetBlockId) {
        super(carpetBlockId);
        setMaxDamage(0);
        setHasSubtypes(true);
    ...
    public Icon getIconFromDamage(int par1) {
        return Decorative.carpetBlock.getIcon(2, BlockCarpet.getBlockFromDye(par1));
    }
    ...
    public void getSubItems(int par1, CreativeTabs par2CreativeTabs, List par3List) {
        Decorative.carpetBlock.getSubBlocks(par1, par2CreativeTabs, par3List);
    }
