...
public class BaseMultiMetaFenceItem<MetaBlock extends BaseMultiMetaBlock> extends ItemBlock {
    protected BaseMultiMetaFenceBlock<MetaBlock> metaBlock;
    public BaseMultiMetaFenceItem(MetaBlock block) {
        this(block.blockID, block);
    }
    public BaseMultiMetaFenceItem(int blockID, Block block) {
        super(blockID);
        this.metaBlock = (BaseMultiMetaFenceBlock<MetaBlock>) block;
